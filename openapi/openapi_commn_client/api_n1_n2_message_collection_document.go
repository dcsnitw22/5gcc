...
func (r ApiN1N2MessageTransferRequest) BinaryDataN1MessageContent(binaryDataN1MessageContent *os.File) ApiN1N2MessageTransferRequest {
	r.binaryDataN1MessageContent = binaryDataN1MessageContent
	return r
}

func (r ApiN1N2MessageTransferRequest) BinaryDataN2InfoContent(binaryDataN2InfoContent *os.File) ApiN1N2MessageTransferRequest {
