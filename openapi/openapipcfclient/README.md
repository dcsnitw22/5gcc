...
------------ | ------------- | ------------- | -------------
*DefaultAPI* | [**SmPoliciesPost**](docs/DefaultAPI.md#smpoliciespost) | **Post** /sm-policies | 
*DefaultAPI* | [**SmPoliciesSmPolicyIdDeletePost**](docs/DefaultAPI.md#smpoliciessmpolicyiddeletepost) | **Post** /sm-policies/{smPolicyId}/delete | 
*DefaultAPI* | [**SmPoliciesSmPolicyIdGet**](docs/DefaultAPI.md#smpoliciessmpolicyidget) | **Get** /sm-policies/{smPolicyId} | 
*DefaultAPI* | [**SmPoliciesSmPolicyIdUpdatePost**](docs/DefaultAPI.md#smpoliciessmpolicyidupdatepost) | **Post** /sm-policies/{smPolicyId}/update | 
