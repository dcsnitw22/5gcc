...
**FlowDirection** | Pointer to [**NullableFlowDirectionRm**](FlowDirectionRm.md) |  | [optional] 
...
`func (o *FlowInformation) SetFlowDirectionNil(b bool)`

 SetFlowDirectionNil sets the value for FlowDirection to be an explicit nil

### UnsetFlowDirection
`func (o *FlowInformation) UnsetFlowDirection()`
