...
**MaxbrUl** | Pointer to **NullableString** |  | [optional] 
**MaxbrDl** | Pointer to **NullableString** |  | [optional] 
**GbrUl** | Pointer to **NullableString** |  | [optional] 
**GbrDl** | Pointer to **NullableString** |  | [optional] 
...
**PriorityLevel** | Pointer to **NullableInt32** |  | [optional] 
**AverWindow** | Pointer to **NullableInt32** |  | [optional] [default to 2000]
**MaxDataBurstVol** | Pointer to **NullableInt32** |  | [optional] 
...
**MaxPacketLossRateDl** | Pointer to **NullableInt32** |  | [optional] 
**MaxPacketLossRateUl** | Pointer to **NullableInt32** |  | [optional] 
