...
**ChargEntityAddr** | Pointer to [**NullableAccNetChargingAddress**](AccNetChargingAddress.md) |  | [optional] 
...
### SetChargEntityAddrNil

`func (o *SmPolicyContextData) SetChargEntityAddrNil(b bool)`

 SetChargEntityAddrNil sets the value for ChargEntityAddr to be an explicit nil

### UnsetChargEntityAddr
