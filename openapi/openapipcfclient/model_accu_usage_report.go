...
// AccuUsageReport struct for AccuUsageReport
...
type _AccuUsageReport AccuUsageReport
...
func (o *AccuUsageReport) UnmarshalJSON(bytes []byte) (err error) {
	...
	varAccuUsageReport := _AccuUsageReport{}

	err = json.Unmarshal(bytes, &varAccuUsageReport)

	if err != nil {
		return err
	}

	*o = AccuUsageReport(varAccuUsageReport)
