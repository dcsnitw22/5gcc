...
// AppDetectionInfo struct for AppDetectionInfo
...
type _AppDetectionInfo AppDetectionInfo
...
func (o *AppDetectionInfo) UnmarshalJSON(bytes []byte) (err error) {
	...
	varAppDetectionInfo := _AppDetectionInfo{}

	err = json.Unmarshal(bytes, &varAppDetectionInfo)

	if err != nil {
		return err
	}

	*o = AppDetectionInfo(varAppDetectionInfo)
