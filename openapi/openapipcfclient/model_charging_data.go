...
type ChargingData struct {
	...
	MeteringMethod NullableMeteringMethod `json:"meteringMethod,omitempty"`
	...
	ReportingLevel NullableReportingLevel `json:"reportingLevel,omitempty"`
...
type _ChargingData ChargingData
...
func (o *ChargingData) GetMeteringMethod() MeteringMethod {
	if o == nil || IsNil(o.MeteringMethod.Get()) {
...
func (o *ChargingData) GetReportingLevel() ReportingLevel {
	if o == nil || IsNil(o.ReportingLevel.Get()) {
...
func (o *ChargingData) UnmarshalJSON(bytes []byte) (err error) {
	...
	varChargingData := _ChargingData{}

	err = json.Unmarshal(bytes, &varChargingData)

	if err != nil {
		return err
	}

	*o = ChargingData(varChargingData)
