...
// FlowInformation struct for FlowInformation
type FlowInformation struct {
	...
	FlowDirection NullableFlowDirectionRm `json:"flowDirection,omitempty"`
}
...
// SetFlowDirection gets a reference to the given NullableFlowDirectionRm and assigns it to the FlowDirection field.
...
func (o *FlowInformation) SetFlowDirectionNil() {
...
func (o FlowInformation) ToMap() (map[string]interface{}, error) {
	...
	if o.FlowDirection.IsSet() {
		toSerialize["flowDirection"] = o.FlowDirection.Get()
	}
