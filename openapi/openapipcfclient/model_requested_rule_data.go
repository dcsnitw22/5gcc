...
// RequestedRuleData struct for RequestedRuleData
...
type _RequestedRuleData RequestedRuleData
...
func (o *RequestedRuleData) UnmarshalJSON(bytes []byte) (err error) {
	...
	varRequestedRuleData := _RequestedRuleData{}

	err = json.Unmarshal(bytes, &varRequestedRuleData)

	if err != nil {
		return err
	}

	*o = RequestedRuleData(varRequestedRuleData)
