...
// SessionRule struct for SessionRule
...
func (o *SessionRule) UnmarshalJSON(bytes []byte) (err error) {
	...
	varSessionRule := _SessionRule{}

	err = json.Unmarshal(bytes, &varSessionRule)

	if err != nil {
		return err
	}

	*o = SessionRule(varSessionRule)
