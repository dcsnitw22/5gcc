...
// AssertFlowDirectionRmRequired checks if the required fields are not zero-ed
func AssertFlowDirectionRmRequired(obj FlowDirectionRm) error {
	return nil
}

// AssertFlowDirectionRmConstraints checks if the values respects the defined constraints
func AssertFlowDirectionRmConstraints(obj FlowDirectionRm) error {
	return nil
}
