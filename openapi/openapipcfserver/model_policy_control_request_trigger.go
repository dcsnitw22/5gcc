...
// AssertPolicyControlRequestTriggerRequired checks if the required fields are not zero-ed
func AssertPolicyControlRequestTriggerRequired(obj PolicyControlRequestTrigger) error {
	return nil
}

// AssertPolicyControlRequestTriggerConstraints checks if the values respects the defined constraints
func AssertPolicyControlRequestTriggerConstraints(obj PolicyControlRequestTrigger) error {
	return nil
}
