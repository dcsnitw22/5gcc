...
// AssertSessionRuleFailureCodeRequired checks if the required fields are not zero-ed
func AssertSessionRuleFailureCodeRequired(obj SessionRuleFailureCode) error {
	return nil
}

// AssertSessionRuleFailureCodeConstraints checks if the values respects the defined constraints
func AssertSessionRuleFailureCodeConstraints(obj SessionRuleFailureCode) error {
	return nil
}
