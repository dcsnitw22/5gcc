...
func (a *SessionManagementSubscriptionDataRetrievalAPIService) GetSmDataExecute(r ApiGetSmDataRequest) (*SmSubsData, *http.Response, error) {
	...
	if r.singleNssai != nil {
		singleNssai_string,_ := json.Marshal(r.singleNssai)
		parameterAddToHeaderOrQuery(localVarQueryParams, "single-nssai", string(singleNssai_string), "")
	}
	if r.dnn != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "dnn", r.dnn, "")
	}
	if r.plmnId != nil {
		plmn_ID_string,_ := json.Marshal(r.plmnId)
		parameterAddToHeaderOrQuery(localVarQueryParams, "plmn-id", string(plmn_ID_string), "")
	}
