...
type _AerialUeSubscriptionInfo1 AerialUeSubscriptionInfo1
...
func (o *AerialUeSubscriptionInfo1) UnmarshalJSON(bytes []byte) (err error) {
	...
	varAerialUeSubscriptionInfo1 := _AerialUeSubscriptionInfo1{}

	err = json.Unmarshal(bytes, &varAerialUeSubscriptionInfo1)

	if err != nil {
		return err
	}

	*o = AerialUeSubscriptionInfo1(varAerialUeSubscriptionInfo1)
