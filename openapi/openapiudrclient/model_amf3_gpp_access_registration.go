...
type _Amf3GppAccessRegistration Amf3GppAccessRegistration
...
func (o *Amf3GppAccessRegistration) UnmarshalJSON(bytes []byte) (err error) {
	...
	varAmf3GppAccessRegistration := _Amf3GppAccessRegistration{}

	err = json.Unmarshal(bytes, &varAmf3GppAccessRegistration)

	if err != nil {
		return err
	}

	*o = Amf3GppAccessRegistration(varAmf3GppAccessRegistration)
