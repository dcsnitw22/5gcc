...
type _AmfNon3GppAccessRegistration AmfNon3GppAccessRegistration
...
func (o *AmfNon3GppAccessRegistration) UnmarshalJSON(bytes []byte) (err error) {
	...
	varAmfNon3GppAccessRegistration := _AmfNon3GppAccessRegistration{}

	err = json.Unmarshal(bytes, &varAmfNon3GppAccessRegistration)

	if err != nil {
		return err
	}

	*o = AmfNon3GppAccessRegistration(varAmfNon3GppAccessRegistration)
