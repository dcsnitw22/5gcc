...
type _AmfSubscriptionInfo AmfSubscriptionInfo
...
func (o *AmfSubscriptionInfo) UnmarshalJSON(bytes []byte) (err error) {
	...
	varAmfSubscriptionInfo := _AmfSubscriptionInfo{}

	err = json.Unmarshal(bytes, &varAmfSubscriptionInfo)

	if err != nil {
		return err
	}

	*o = AmfSubscriptionInfo(varAmfSubscriptionInfo)
