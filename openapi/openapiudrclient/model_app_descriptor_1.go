...
type _AppDescriptor1 AppDescriptor1
...
func (o *AppDescriptor1) UnmarshalJSON(bytes []byte) (err error) {
	...
	varAppDescriptor1 := _AppDescriptor1{}

	err = json.Unmarshal(bytes, &varAppDescriptor1)

	if err != nil {
		return err
	}

	*o = AppDescriptor1(varAppDescriptor1)
