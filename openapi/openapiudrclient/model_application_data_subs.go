...
type _ApplicationDataSubs ApplicationDataSubs
...
func (o *ApplicationDataSubs) UnmarshalJSON(bytes []byte) (err error) {
	...
	varApplicationDataSubs := _ApplicationDataSubs{}

	err = json.Unmarshal(bytes, &varApplicationDataSubs)

	if err != nil {
		return err
	}

	*o = ApplicationDataSubs(varApplicationDataSubs)
