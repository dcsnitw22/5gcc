...
func NewArp1(priorityLevel NullableInt32,
	//  preemptCap PreemptionCapability, 
	 preemptVuln PreemptionVulnerability) *Arp1 {
	this := Arp1{}
...
func (o *Arp1) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varArp1)
