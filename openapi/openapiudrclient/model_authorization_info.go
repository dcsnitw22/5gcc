...
type _AuthorizationInfo AuthorizationInfo
...
func (o *AuthorizationInfo) UnmarshalJSON(bytes []byte) (err error) {
	...
	varAuthorizationInfo := _AuthorizationInfo{}

	err = json.Unmarshal(bytes, &varAuthorizationInfo)

	if err != nil {
		return err
	}

	*o = AuthorizationInfo(varAuthorizationInfo)
