...
type _BdtPolicyData BdtPolicyData
...
func (o *BdtPolicyData) UnmarshalJSON(bytes []byte) (err error) {
	...
	varBdtPolicyData := _BdtPolicyData{}

	err = json.Unmarshal(bytes, &varBdtPolicyData)

	if err != nil {
		return err
	}

	*o = BdtPolicyData(varBdtPolicyData)
