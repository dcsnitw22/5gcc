...
func (o *CagAckData) UnmarshalJSON(bytes []byte) (err error) {
	...
	varCagAckData := _CagAckData{}

	err = json.Unmarshal(bytes, &varCagAckData)

	if err != nil {
		return err
	}

	*o = CagAckData(varCagAckData)
