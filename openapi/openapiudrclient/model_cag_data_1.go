...
func (o *CagData1) UnmarshalJSON(bytes []byte) (err error) {
	...
	varCagData1 := _CagData1{}

	err = json.Unmarshal(bytes, &varCagData1)

	if err != nil {
		return err
	}

	*o = CagData1(varCagData1)
