...
func (o *DataFilter) UnmarshalJSON(bytes []byte) (err error) {
	...
	varDataFilter := _DataFilter{}

	err = json.Unmarshal(bytes, &varDataFilter)

	if err != nil {
		return err
	}

	*o = DataFilter(varDataFilter)
