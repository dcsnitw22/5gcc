...
type DnnConfiguration1 struct {
	...
	DnAaaAddress NullableIpAddress1 `json:"dnAaaAddress,omitempty"`
...
type _DnnConfiguration1 DnnConfiguration1
...
// SetDnAaaAddress gets a reference to the given NullableIpAddress1 and assigns it to the DnAaaAddress field.
...
func (o *DnnConfiguration1) UnmarshalJSON(bytes []byte) (err error) {
	...
	varDnnConfiguration1 := _DnnConfiguration1{}

	err = json.Unmarshal(bytes, &varDnnConfiguration1)

	if err != nil {
		return err
	}

	*o = DnnConfiguration1(varDnnConfiguration1)
