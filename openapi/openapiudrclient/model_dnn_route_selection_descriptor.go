...
type _DnnRouteSelectionDescriptor DnnRouteSelectionDescriptor
...
func (o *DnnRouteSelectionDescriptor) UnmarshalJSON(bytes []byte) (err error) {
	...
	varDnnRouteSelectionDescriptor := _DnnRouteSelectionDescriptor{}

	err = json.Unmarshal(bytes, &varDnnRouteSelectionDescriptor)

	if err != nil {
		return err
	}

	*o = DnnRouteSelectionDescriptor(varDnnRouteSelectionDescriptor)
