...
type _EcRestriction1 EcRestriction1
...
func (o *EcRestriction1) UnmarshalJSON(bytes []byte) (err error) {
	...
	varEcRestriction1 := _EcRestriction1{}

	err = json.Unmarshal(bytes, &varEcRestriction1)

	if err != nil {
		return err
	}

	*o = EcRestriction1(varEcRestriction1)
