...
// checks if the EeSubscription1 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EeSubscription1{}
...
type _EeSubscription1 EeSubscription1
...
func (o *EeSubscription1) GetUdrRestartInd() bool {
...
// and a boolean to check if the value has been set.
func (o *EeSubscription1) GetUdrRestartIndOk() (*bool, bool) {
	if o == nil || IsNil(o.UdrRestartInd) {
		return nil, false
	}
...
func (o *EeSubscription1) HasUdrRestartInd() bool {
	if o != nil && !IsNil(o.UdrRestartInd) {
		return true
	}
...
func (o *EeSubscription1) SetUdrRestartInd(v bool) {
	o.UdrRestartInd = &v
}
...
func (o *EeSubscription1) UnmarshalJSON(bytes []byte) (err error) {
	...
	varEeSubscription1 := _EeSubscription1{}

	err = json.Unmarshal(bytes, &varEeSubscription1)

	if err != nil {
		return err
	}

	*o = EeSubscription1(varEeSubscription1)
