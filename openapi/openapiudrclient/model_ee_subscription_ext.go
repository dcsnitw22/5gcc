...
type _EeSubscriptionExt EeSubscriptionExt
...
func (o *EeSubscriptionExt) UnmarshalJSON(bytes []byte) (err error) {
	...
	varEeSubscriptionExt := _EeSubscriptionExt{}

	err = json.Unmarshal(bytes, &varEeSubscriptionExt)

	if err != nil {
		return err
	}

	*o = EeSubscriptionExt(varEeSubscriptionExt)
