...
type EutraLocation struct {
	...
	GlobalNgenbId NullableGlobalRanNodeId1 `json:"globalNgenbId,omitempty"`
	GlobalENbId NullableGlobalRanNodeId1 `json:"globalENbId,omitempty"`
}
...
// SetGlobalNgenbId gets a reference to the given NullableGlobalRanNodeId1 and assigns it to the GlobalNgenbId field.
...
// SetGlobalENbId gets a reference to the given NullableGlobalRanNodeId1 and assigns it to the GlobalENbId field.
...
func (o *EutraLocation) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varEutraLocation)
