...
type _ExposureDataSubscription ExposureDataSubscription
...
func (o *ExposureDataSubscription) UnmarshalJSON(bytes []byte) (err error) {
	...
	varExposureDataSubscription := _ExposureDataSubscription{}

	err = json.Unmarshal(bytes, &varExposureDataSubscription)

	if err != nil {
		return err
	}

	*o = ExposureDataSubscription(varExposureDataSubscription)
