...
type _HssSubscriptionItem HssSubscriptionItem
...
func (o *HssSubscriptionItem) UnmarshalJSON(bytes []byte) (err error) {
	...
	varHssSubscriptionItem := _HssSubscriptionItem{}

	err = json.Unmarshal(bytes, &varHssSubscriptionItem)

	if err != nil {
		return err
	}

	*o = HssSubscriptionItem(varHssSubscriptionItem)
