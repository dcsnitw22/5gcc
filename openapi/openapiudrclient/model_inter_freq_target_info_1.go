...
type _InterFreqTargetInfo1 InterFreqTargetInfo1
...
func (o *InterFreqTargetInfo1) UnmarshalJSON(bytes []byte) (err error) {
	...
	varInterFreqTargetInfo1 := _InterFreqTargetInfo1{}

	err = json.Unmarshal(bytes, &varInterFreqTargetInfo1)

	if err != nil {
		return err
	}

	*o = InterFreqTargetInfo1(varInterFreqTargetInfo1)
