...
type _LocationReportingConfiguration1 LocationReportingConfiguration1
...
func (o *LocationReportingConfiguration1) UnmarshalJSON(bytes []byte) (err error) {
	...
	varLocationReportingConfiguration1 := _LocationReportingConfiguration1{}

	err = json.Unmarshal(bytes, &varLocationReportingConfiguration1)

	if err != nil {
		return err
	}

	*o = LocationReportingConfiguration1(varLocationReportingConfiguration1)
