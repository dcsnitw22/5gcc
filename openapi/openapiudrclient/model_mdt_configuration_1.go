...
type _MdtConfiguration1 MdtConfiguration1
...
func (o *MdtConfiguration1) UnmarshalJSON(bytes []byte) (err error) {
	...
	varMdtConfiguration1 := _MdtConfiguration1{}

	err = json.Unmarshal(bytes, &varMdtConfiguration1)

	if err != nil {
		return err
	}

	*o = MdtConfiguration1(varMdtConfiguration1)
