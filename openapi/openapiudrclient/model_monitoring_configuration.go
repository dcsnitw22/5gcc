...
type _MonitoringConfiguration MonitoringConfiguration
...
func (o *MonitoringConfiguration) UnmarshalJSON(bytes []byte) (err error) {
	...
	varMonitoringConfiguration := _MonitoringConfiguration{}

	err = json.Unmarshal(bytes, &varMonitoringConfiguration)

	if err != nil {
		return err
	}

	*o = MonitoringConfiguration(varMonitoringConfiguration)
