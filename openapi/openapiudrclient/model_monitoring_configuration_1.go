...
type _MonitoringConfiguration1 MonitoringConfiguration1
...
func (o *MonitoringConfiguration1) UnmarshalJSON(bytes []byte) (err error) {
	...
	varMonitoringConfiguration1 := _MonitoringConfiguration1{}

	err = json.Unmarshal(bytes, &varMonitoringConfiguration1)

	if err != nil {
		return err
	}

	*o = MonitoringConfiguration1(varMonitoringConfiguration1)
