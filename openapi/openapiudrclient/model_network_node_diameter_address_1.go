...
type _NetworkNodeDiameterAddress1 NetworkNodeDiameterAddress1
...
func (o *NetworkNodeDiameterAddress1) UnmarshalJSON(bytes []byte) (err error) {
	...
	varNetworkNodeDiameterAddress1 := _NetworkNodeDiameterAddress1{}

	err = json.Unmarshal(bytes, &varNetworkNodeDiameterAddress1)

	if err != nil {
		return err
	}

	*o = NetworkNodeDiameterAddress1(varNetworkNodeDiameterAddress1)
