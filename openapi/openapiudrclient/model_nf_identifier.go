...
type _NfIdentifier NfIdentifier
...
func (o *NfIdentifier) UnmarshalJSON(bytes []byte) (err error) {
	...
	varNfIdentifier := _NfIdentifier{}

	err = json.Unmarshal(bytes, &varNfIdentifier)

	if err != nil {
		return err
	}

	*o = NfIdentifier(varNfIdentifier)
