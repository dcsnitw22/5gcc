...
type _NiddInformation1 NiddInformation1
...
func (o *NiddInformation1) UnmarshalJSON(bytes []byte) (err error) {
	...
	varNiddInformation1 := _NiddInformation1{}

	err = json.Unmarshal(bytes, &varNiddInformation1)

	if err != nil {
		return err
	}

	*o = NiddInformation1(varNiddInformation1)
