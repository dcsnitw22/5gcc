...
type NrLocation struct {
	...
	GlobalGnbId NullableGlobalRanNodeId1 `json:"globalGnbId,omitempty"`
}
...
// SetGlobalGnbId gets a reference to the given NullableGlobalRanNodeId1 and assigns it to the GlobalGnbId field.
