...
type _NssaiAckData NssaiAckData
...
func (o *NssaiAckData) UnmarshalJSON(bytes []byte) (err error) {
	...
	varNssaiAckData := _NssaiAckData{}

	err = json.Unmarshal(bytes, &varNssaiAckData)

	if err != nil {
		return err
	}

	*o = NssaiAckData(varNssaiAckData)
