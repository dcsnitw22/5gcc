...
type _OperatorSpecificDataContainer OperatorSpecificDataContainer
...
func (o *OperatorSpecificDataContainer) UnmarshalJSON(bytes []byte) (err error) {
	...
	varOperatorSpecificDataContainer := _OperatorSpecificDataContainer{}

	err = json.Unmarshal(bytes, &varOperatorSpecificDataContainer)

	if err != nil {
		return err
	}

	*o = OperatorSpecificDataContainer(varOperatorSpecificDataContainer)
