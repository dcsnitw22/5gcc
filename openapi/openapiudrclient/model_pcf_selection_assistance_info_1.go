...
type _PcfSelectionAssistanceInfo1 PcfSelectionAssistanceInfo1
...
func (o *PcfSelectionAssistanceInfo1) UnmarshalJSON(bytes []byte) (err error) {
	...
	varPcfSelectionAssistanceInfo1 := _PcfSelectionAssistanceInfo1{}

	err = json.Unmarshal(bytes, &varPcfSelectionAssistanceInfo1)

	if err != nil {
		return err
	}

	*o = PcfSelectionAssistanceInfo1(varPcfSelectionAssistanceInfo1)
