...
type _PfdChangeNotification PfdChangeNotification
...
func (o *PfdChangeNotification) UnmarshalJSON(bytes []byte) (err error) {
	...
	varPfdChangeNotification := _PfdChangeNotification{}

	err = json.Unmarshal(bytes, &varPfdChangeNotification)

	if err != nil {
		return err
	}

	*o = PfdChangeNotification(varPfdChangeNotification)
