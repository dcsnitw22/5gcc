...
type _PfdDataForAppExt PfdDataForAppExt
...
func (o *PfdDataForAppExt) UnmarshalJSON(bytes []byte) (err error) {
	...
	varPfdDataForAppExt := _PfdDataForAppExt{}

	err = json.Unmarshal(bytes, &varPfdDataForAppExt)

	if err != nil {
		return err
	}

	*o = PfdDataForAppExt(varPfdDataForAppExt)
