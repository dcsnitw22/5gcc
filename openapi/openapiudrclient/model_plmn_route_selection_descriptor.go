...
type _PlmnRouteSelectionDescriptor PlmnRouteSelectionDescriptor
...
func (o *PlmnRouteSelectionDescriptor) UnmarshalJSON(bytes []byte) (err error) {
	...
	varPlmnRouteSelectionDescriptor := _PlmnRouteSelectionDescriptor{}

	err = json.Unmarshal(bytes, &varPlmnRouteSelectionDescriptor)

	if err != nil {
		return err
	}

	*o = PlmnRouteSelectionDescriptor(varPlmnRouteSelectionDescriptor)
