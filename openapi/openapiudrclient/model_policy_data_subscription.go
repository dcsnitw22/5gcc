...
type _PolicyDataSubscription PolicyDataSubscription
...
func (o *PolicyDataSubscription) UnmarshalJSON(bytes []byte) (err error) {
	...
	varPolicyDataSubscription := _PolicyDataSubscription{}

	err = json.Unmarshal(bytes, &varPolicyDataSubscription)

	if err != nil {
		return err
	}

	*o = PolicyDataSubscription(varPolicyDataSubscription)
