...
type _PpDlPacketCountExt PpDlPacketCountExt
...
func (o *PpDlPacketCountExt) UnmarshalJSON(bytes []byte) (err error) {
	...
	varPpDlPacketCountExt := _PpDlPacketCountExt{}

	err = json.Unmarshal(bytes, &varPpDlPacketCountExt)

	if err != nil {
		return err
	}

	*o = PpDlPacketCountExt(varPpDlPacketCountExt)
