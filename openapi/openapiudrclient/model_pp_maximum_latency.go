...
type _PpMaximumLatency PpMaximumLatency
...
func (o *PpMaximumLatency) UnmarshalJSON(bytes []byte) (err error) {
	...
	varPpMaximumLatency := _PpMaximumLatency{}

	err = json.Unmarshal(bytes, &varPpMaximumLatency)

	if err != nil {
		return err
	}

	*o = PpMaximumLatency(varPpMaximumLatency)
