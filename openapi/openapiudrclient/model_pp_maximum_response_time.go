...
type _PpMaximumResponseTime PpMaximumResponseTime
...
func (o *PpMaximumResponseTime) UnmarshalJSON(bytes []byte) (err error) {
	...
	varPpMaximumResponseTime := _PpMaximumResponseTime{}

	err = json.Unmarshal(bytes, &varPpMaximumResponseTime)

	if err != nil {
		return err
	}

	*o = PpMaximumResponseTime(varPpMaximumResponseTime)
