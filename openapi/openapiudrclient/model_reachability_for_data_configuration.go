...
type _ReachabilityForDataConfiguration ReachabilityForDataConfiguration
...
func (o *ReachabilityForDataConfiguration) UnmarshalJSON(bytes []byte) (err error) {
	...
	varReachabilityForDataConfiguration := _ReachabilityForDataConfiguration{}

	err = json.Unmarshal(bytes, &varReachabilityForDataConfiguration)

	if err != nil {
		return err
	}

	*o = ReachabilityForDataConfiguration(varReachabilityForDataConfiguration)
