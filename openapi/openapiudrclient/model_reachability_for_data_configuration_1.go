...
type _ReachabilityForDataConfiguration1 ReachabilityForDataConfiguration1
...
func (o *ReachabilityForDataConfiguration1) UnmarshalJSON(bytes []byte) (err error) {
	...
	varReachabilityForDataConfiguration1 := _ReachabilityForDataConfiguration1{}

	err = json.Unmarshal(bytes, &varReachabilityForDataConfiguration1)

	if err != nil {
		return err
	}

	*o = ReachabilityForDataConfiguration1(varReachabilityForDataConfiguration1)
