...
type _RoamingInfoUpdate RoamingInfoUpdate
...
func (o *RoamingInfoUpdate) UnmarshalJSON(bytes []byte) (err error) {
	...
	varRoamingInfoUpdate := _RoamingInfoUpdate{}

	err = json.Unmarshal(bytes, &varRoamingInfoUpdate)

	if err != nil {
		return err
	}

	*o = RoamingInfoUpdate(varRoamingInfoUpdate)
