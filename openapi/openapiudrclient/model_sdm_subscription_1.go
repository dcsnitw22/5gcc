...
type _SdmSubscription1 SdmSubscription1
...
func (o *SdmSubscription1) GetDataRestorationCallbackUri() string {
...
// and a boolean to check if the value has been set.
func (o *SdmSubscription1) GetDataRestorationCallbackUriOk() (*string, bool) {
	if o == nil || IsNil(o.DataRestorationCallbackUri) {
		return nil, false
	}
...
func (o *SdmSubscription1) HasDataRestorationCallbackUri() bool {
	if o != nil && !IsNil(o.DataRestorationCallbackUri) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *SdmSubscription1) GetUdrRestartIndOk() (*bool, bool) {
	if o == nil || IsNil(o.UdrRestartInd) {
		return nil, false
	}
...
func (o *SdmSubscription1) HasUdrRestartInd() bool {
	if o != nil && !IsNil(o.UdrRestartInd) {
		return true
	}
...
func (o *SdmSubscription1) SetUdrRestartInd(v bool) {
	o.UdrRestartInd = &v
}
...
func (o *SdmSubscription1) UnmarshalJSON(bytes []byte) (err error) {
	...
	varSdmSubscription1 := _SdmSubscription1{}

	err = json.Unmarshal(bytes, &varSdmSubscription1)

	if err != nil {
		return err
	}

	*o = SdmSubscription1(varSdmSubscription1)
