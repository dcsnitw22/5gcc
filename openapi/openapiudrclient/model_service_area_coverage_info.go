...
type _ServiceAreaCoverageInfo ServiceAreaCoverageInfo
...
func (o *ServiceAreaCoverageInfo) UnmarshalJSON(bytes []byte) (err error) {
	...
	varServiceAreaCoverageInfo := _ServiceAreaCoverageInfo{}

	err = json.Unmarshal(bytes, &varServiceAreaCoverageInfo)

	if err != nil {
		return err
	}

	*o = ServiceAreaCoverageInfo(varServiceAreaCoverageInfo)
