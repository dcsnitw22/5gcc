...
type _SmPolicyData SmPolicyData
...
func (o *SmPolicyData) UnmarshalJSON(bytes []byte) (err error) {
	...
	varSmPolicyData := _SmPolicyData{}

	err = json.Unmarshal(bytes, &varSmPolicyData)

	if err != nil {
		return err
	}

	*o = SmPolicyData(varSmPolicyData)
