...
type _SmPolicyDnnData SmPolicyDnnData
...
func (o *SmPolicyDnnData) UnmarshalJSON(bytes []byte) (err error) {
	...
	varSmPolicyDnnData := _SmPolicyDnnData{}

	err = json.Unmarshal(bytes, &varSmPolicyDnnData)

	if err != nil {
		return err
	}

	*o = SmPolicyDnnData(varSmPolicyDnnData)
