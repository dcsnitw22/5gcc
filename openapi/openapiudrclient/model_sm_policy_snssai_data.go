...
type _SmPolicySnssaiData SmPolicySnssaiData
...
func (o *SmPolicySnssaiData) UnmarshalJSON(bytes []byte) (err error) {
	...
	varSmPolicySnssaiData := _SmPolicySnssaiData{}

	err = json.Unmarshal(bytes, &varSmPolicySnssaiData)

	if err != nil {
		return err
	}

	*o = SmPolicySnssaiData(varSmPolicySnssaiData)
