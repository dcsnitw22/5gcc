...
type _SmPolicySnssaiDataPatch SmPolicySnssaiDataPatch
...
func (o *SmPolicySnssaiDataPatch) UnmarshalJSON(bytes []byte) (err error) {
	...
	varSmPolicySnssaiDataPatch := _SmPolicySnssaiDataPatch{}

	err = json.Unmarshal(bytes, &varSmPolicySnssaiDataPatch)

	if err != nil {
		return err
	}

	*o = SmPolicySnssaiDataPatch(varSmPolicySnssaiDataPatch)
