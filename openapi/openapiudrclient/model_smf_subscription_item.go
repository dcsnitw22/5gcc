...
type _SmfSubscriptionItem SmfSubscriptionItem
...
func (o *SmfSubscriptionItem) UnmarshalJSON(bytes []byte) (err error) {
	...
	varSmfSubscriptionItem := _SmfSubscriptionItem{}

	err = json.Unmarshal(bytes, &varSmfSubscriptionItem)

	if err != nil {
		return err
	}

	*o = SmfSubscriptionItem(varSmfSubscriptionItem)
