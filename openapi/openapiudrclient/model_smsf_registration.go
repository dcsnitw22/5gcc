...
type _SmsfRegistration SmsfRegistration
...
func (o *SmsfRegistration) UnmarshalJSON(bytes []byte) (err error) {
	...
	varSmsfRegistration := _SmsfRegistration{}

	err = json.Unmarshal(bytes, &varSmsfRegistration)

	if err != nil {
		return err
	}

	*o = SmsfRegistration(varSmsfRegistration)
