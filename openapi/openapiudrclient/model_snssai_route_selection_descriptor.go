...
type _SnssaiRouteSelectionDescriptor SnssaiRouteSelectionDescriptor
...
func (o *SnssaiRouteSelectionDescriptor) UnmarshalJSON(bytes []byte) (err error) {
	...
	varSnssaiRouteSelectionDescriptor := _SnssaiRouteSelectionDescriptor{}

	err = json.Unmarshal(bytes, &varSnssaiRouteSelectionDescriptor)

	if err != nil {
		return err
	}

	*o = SnssaiRouteSelectionDescriptor(varSnssaiRouteSelectionDescriptor)
