...
func (o *SorInfo1) UnmarshalJSON(bytes []byte) (err error) {
	...
	varSorInfo1 := _SorInfo1{}

	err = json.Unmarshal(bytes, &varSorInfo1)

	if err != nil {
		return err
	}

	*o = SorInfo1(varSorInfo1)
