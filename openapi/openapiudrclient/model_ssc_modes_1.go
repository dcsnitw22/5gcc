...
func (o *SscModes1) UnmarshalJSON(bytes []byte) (err error) {
	...
	varSscModes1 := _SscModes1{}

	err = json.Unmarshal(bytes, &varSscModes1)

	if err != nil {
		return err
	}

	*o = SscModes1(varSscModes1)
