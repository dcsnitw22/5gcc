...
type _SubscriptionDataSubscriptions SubscriptionDataSubscriptions
...
func (o *SubscriptionDataSubscriptions) UnmarshalJSON(bytes []byte) (err error) {
	...
	varSubscriptionDataSubscriptions := _SubscriptionDataSubscriptions{}

	err = json.Unmarshal(bytes, &varSubscriptionDataSubscriptions)

	if err != nil {
		return err
	}

	*o = SubscriptionDataSubscriptions(varSubscriptionDataSubscriptions)
