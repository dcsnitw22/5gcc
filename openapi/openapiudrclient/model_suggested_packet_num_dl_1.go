...
type _SuggestedPacketNumDl1 SuggestedPacketNumDl1
...
func (o *SuggestedPacketNumDl1) UnmarshalJSON(bytes []byte) (err error) {
	...
	varSuggestedPacketNumDl1 := _SuggestedPacketNumDl1{}

	err = json.Unmarshal(bytes, &varSuggestedPacketNumDl1)

	if err != nil {
		return err
	}

	*o = SuggestedPacketNumDl1(varSuggestedPacketNumDl1)
