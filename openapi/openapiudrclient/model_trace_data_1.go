...
// checks if the TraceData1 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TraceData1{}
...
func (o *TraceData1) UnmarshalJSON(bytes []byte) (err error) {
	...
	varTraceData1 := _TraceData1{}

	err = json.Unmarshal(bytes, &varTraceData1)

	if err != nil {
		return err
	}

	*o = TraceData1(varTraceData1)
