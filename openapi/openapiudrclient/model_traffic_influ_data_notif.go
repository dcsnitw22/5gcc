...
type _TrafficInfluDataNotif TrafficInfluDataNotif
...
func (o *TrafficInfluDataNotif) UnmarshalJSON(bytes []byte) (err error) {
	...
	varTrafficInfluDataNotif := _TrafficInfluDataNotif{}

	err = json.Unmarshal(bytes, &varTrafficInfluDataNotif)

	if err != nil {
		return err
	}

	*o = TrafficInfluDataNotif(varTrafficInfluDataNotif)
