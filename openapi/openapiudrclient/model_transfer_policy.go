...
type _TransferPolicy TransferPolicy
...
func (o *TransferPolicy) UnmarshalJSON(bytes []byte) (err error) {
	...
	varTransferPolicy := _TransferPolicy{}

	err = json.Unmarshal(bytes, &varTransferPolicy)

	if err != nil {
		return err
	}

	*o = TransferPolicy(varTransferPolicy)
