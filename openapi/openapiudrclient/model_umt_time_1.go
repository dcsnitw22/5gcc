...
func (o *UmtTime1) UnmarshalJSON(bytes []byte) (err error) {
	...
	varUmtTime1 := _UmtTime1{}

	err = json.Unmarshal(bytes, &varUmtTime1)

	if err != nil {
		return err
	}

	*o = UmtTime1(varUmtTime1)
