...
func (o *UpSecurity1) UnmarshalJSON(bytes []byte) (err error) {
	...
	varUpSecurity1 := _UpSecurity1{}

	err = json.Unmarshal(bytes, &varUpSecurity1)

	if err != nil {
		return err
	}

	*o = UpSecurity1(varUpSecurity1)
