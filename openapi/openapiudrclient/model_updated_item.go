...
func (o *UpdatedItem) UnmarshalJSON(bytes []byte) (err error) {
	...
	varUpdatedItem := _UpdatedItem{}

	err = json.Unmarshal(bytes, &varUpdatedItem)

	if err != nil {
		return err
	}

	*o = UpdatedItem(varUpdatedItem)
