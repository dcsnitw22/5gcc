...
type _UsageMonDataScope UsageMonDataScope
...
func (o *UsageMonDataScope) UnmarshalJSON(bytes []byte) (err error) {
	...
	varUsageMonDataScope := _UsageMonDataScope{}

	err = json.Unmarshal(bytes, &varUsageMonDataScope)

	if err != nil {
		return err
	}

	*o = UsageMonDataScope(varUsageMonDataScope)
