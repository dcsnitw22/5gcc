...
type _UserIdentifier UserIdentifier
...
func (o *UserIdentifier) UnmarshalJSON(bytes []byte) (err error) {
	...
	varUserIdentifier := _UserIdentifier{}

	err = json.Unmarshal(bytes, &varUserIdentifier)

	if err != nil {
		return err
	}

	*o = UserIdentifier(varUserIdentifier)
