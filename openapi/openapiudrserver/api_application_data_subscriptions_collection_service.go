...
// ApplicationDataSubscriptionsCollectionAPIService is a service that implements the logic for the ApplicationDataSubscriptionsCollectionAPIServicer
// This service should implement the business logic for every endpoint for the ApplicationDataSubscriptionsCollectionAPI API.
// Include any external packages or services that will be required by this service.
type ApplicationDataSubscriptionsCollectionAPIService struct {
}

// NewApplicationDataSubscriptionsCollectionAPIService creates a default api service
func NewApplicationDataSubscriptionsCollectionAPIService() ApplicationDataSubscriptionsCollectionAPIServicer {
	return &ApplicationDataSubscriptionsCollectionAPIService{}
}

// CreateIndividualApplicationDataSubscription - Create a subscription to receive notification of application data changes
func (s *ApplicationDataSubscriptionsCollectionAPIService) CreateIndividualApplicationDataSubscription(ctx context.Context, applicationDataSubs ApplicationDataSubs) (ImplResponse, error) {
	// TODO - update CreateIndividualApplicationDataSubscription with the required logic for this service method.
	// Add api_application_data_subscriptions_collection_service.go to the .openapi-generator-ignore to avoid overwriting this service implementation when updating open api generation.

	// TODO: Uncomment the next line to return response Response(201, ApplicationDataSubs{}) or use other options such as http.Ok ...
	// return Response(201, ApplicationDataSubs{}), nil
	...
	return Response(http.StatusNotImplemented, nil), errors.New("CreateIndividualApplicationDataSubscription method not implemented")
}

// ReadApplicationDataChangeSubscriptions - Read Application Data change Subscriptions
func (s *ApplicationDataSubscriptionsCollectionAPIService) ReadApplicationDataChangeSubscriptions(ctx context.Context, dataFilter DataFilter) (ImplResponse, error) {
	// TODO - update ReadApplicationDataChangeSubscriptions with the required logic for this service method.
	// Add api_application_data_subscriptions_collection_service.go to the .openapi-generator-ignore to avoid overwriting this service implementation when updating open api generation.
	...
	return Response(http.StatusNotImplemented, nil), errors.New("ReadApplicationDataChangeSubscriptions method not implemented")
}
