...
// BdtDataStoreAPIService is a service that implements the logic for the BdtDataStoreAPIServicer
// This service should implement the business logic for every endpoint for the BdtDataStoreAPI API.
// Include any external packages or services that will be required by this service.
type BdtDataStoreAPIService struct {
}

// NewBdtDataStoreAPIService creates a default api service
func NewBdtDataStoreAPIService() BdtDataStoreAPIServicer {
	return &BdtDataStoreAPIService{}
}

// ReadBdtData - Retrieves the BDT data collection
func (s *BdtDataStoreAPIService) ReadBdtData(ctx context.Context, bdtRefIds []string, suppFeat string) (ImplResponse, error) {
	// TODO - update ReadBdtData with the required logic for this service method.
	// Add api_bdt_data_store_service.go to the .openapi-generator-ignore to avoid overwriting this service implementation when updating open api generation.
	...
	return Response(http.StatusNotImplemented, nil), errors.New("ReadBdtData method not implemented")
}
