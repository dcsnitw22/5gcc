...
// Class5GMBSGroupStoreAPIService is a service that implements the logic for the Class5GMBSGroupStoreAPIServicer
// This service should implement the business logic for every endpoint for the Class5GMBSGroupStoreAPI API.
// Include any external packages or services that will be required by this service.
type Class5GMBSGroupStoreAPIService struct {
}

// NewClass5GMBSGroupStoreAPIService creates a default api service
func NewClass5GMBSGroupStoreAPIService() Class5GMBSGroupStoreAPIServicer {
	return &Class5GMBSGroupStoreAPIService{}
}

// Query5GmbsGroup - Retrieves the data of a 5G MBS Group
func (s *Class5GMBSGroupStoreAPIService) Query5GmbsGroup(ctx context.Context, gpsis []string) (ImplResponse, error) {
	// TODO - update Query5GmbsGroup with the required logic for this service method.
	// Add api_class5_gmbs_group_store_service.go to the .openapi-generator-ignore to avoid overwriting this service implementation when updating open api generation.
	...
	return Response(http.StatusNotImplemented, nil), errors.New("Query5GmbsGroup method not implemented")
}
