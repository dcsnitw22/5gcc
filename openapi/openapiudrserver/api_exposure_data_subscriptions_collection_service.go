...
// ExposureDataSubscriptionsCollectionAPIService is a service that implements the logic for the ExposureDataSubscriptionsCollectionAPIServicer
// This service should implement the business logic for every endpoint for the ExposureDataSubscriptionsCollectionAPI API.
// Include any external packages or services that will be required by this service.
type ExposureDataSubscriptionsCollectionAPIService struct {
}

// NewExposureDataSubscriptionsCollectionAPIService creates a default api service
func NewExposureDataSubscriptionsCollectionAPIService() ExposureDataSubscriptionsCollectionAPIServicer {
	return &ExposureDataSubscriptionsCollectionAPIService{}
}

// CreateIndividualExposureDataSubscription - Create a subscription to receive notification of exposure data changes
func (s *ExposureDataSubscriptionsCollectionAPIService) CreateIndividualExposureDataSubscription(ctx context.Context, exposureDataSubscription ExposureDataSubscription) (ImplResponse, error) {
	// TODO - update CreateIndividualExposureDataSubscription with the required logic for this service method.
	// Add api_exposure_data_subscriptions_collection_service.go to the .openapi-generator-ignore to avoid overwriting this service implementation when updating open api generation.

	// TODO: Uncomment the next line to return response Response(201, ExposureDataSubscription{}) or use other options such as http.Ok ...
	// return Response(201, ExposureDataSubscription{}), nil
	...
	return Response(http.StatusNotImplemented, nil), errors.New("CreateIndividualExposureDataSubscription method not implemented")
}
