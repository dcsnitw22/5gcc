...
func (s *GroupIdentifiersAPIService) GetGroupIdentifiers(ctx context.Context, extGroupId string, intGroupId string, ueIdInd bool, supportedFeatures string) (ImplResponse, error) {
