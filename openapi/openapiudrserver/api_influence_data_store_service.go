...
// InfluenceDataStoreAPIService is a service that implements the logic for the InfluenceDataStoreAPIServicer
// This service should implement the business logic for every endpoint for the InfluenceDataStoreAPI API.
// Include any external packages or services that will be required by this service.
type InfluenceDataStoreAPIService struct {
}

// NewInfluenceDataStoreAPIService creates a default api service
func NewInfluenceDataStoreAPIService() InfluenceDataStoreAPIServicer {
	return &InfluenceDataStoreAPIService{}
}

// ReadInfluenceData - Retrieve Traffic Influence Data
func (s *InfluenceDataStoreAPIService) ReadInfluenceData(ctx context.Context, influenceIds []string, dnns []string, snssais []Snssai, internalGroupIds []string, supis []string, suppFeat string) (ImplResponse, error) {
	// TODO - update ReadInfluenceData with the required logic for this service method.
	// Add api_influence_data_store_service.go to the .openapi-generator-ignore to avoid overwriting this service implementation when updating open api generation.
	...
	return Response(http.StatusNotImplemented, nil), errors.New("ReadInfluenceData method not implemented")
}
