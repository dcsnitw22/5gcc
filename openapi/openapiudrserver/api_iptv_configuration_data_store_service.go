...
// IPTVConfigurationDataStoreAPIService is a service that implements the logic for the IPTVConfigurationDataStoreAPIServicer
// This service should implement the business logic for every endpoint for the IPTVConfigurationDataStoreAPI API.
// Include any external packages or services that will be required by this service.
type IPTVConfigurationDataStoreAPIService struct {
}

// NewIPTVConfigurationDataStoreAPIService creates a default api service
func NewIPTVConfigurationDataStoreAPIService() IPTVConfigurationDataStoreAPIServicer {
	return &IPTVConfigurationDataStoreAPIService{}
}

// ReadIPTVCongifurationData - Retrieve IPTV configuration Data
func (s *IPTVConfigurationDataStoreAPIService) ReadIPTVCongifurationData(ctx context.Context, configIds []string, dnns []string, snssais []Snssai, supis []string, interGroupIds []string) (ImplResponse, error) {
	// TODO - update ReadIPTVCongifurationData with the required logic for this service method.
	// Add api_iptv_configuration_data_store_service.go to the .openapi-generator-ignore to avoid overwriting this service implementation when updating open api generation.
	...
	return Response(http.StatusNotImplemented, nil), errors.New("ReadIPTVCongifurationData method not implemented")
}
