...
// PlmnUePolicySetDocumentAPIService is a service that implements the logic for the PlmnUePolicySetDocumentAPIServicer
// This service should implement the business logic for every endpoint for the PlmnUePolicySetDocumentAPI API.
// Include any external packages or services that will be required by this service.
type PlmnUePolicySetDocumentAPIService struct {
}

// NewPlmnUePolicySetDocumentAPIService creates a default api service
func NewPlmnUePolicySetDocumentAPIService() PlmnUePolicySetDocumentAPIServicer {
	return &PlmnUePolicySetDocumentAPIService{}
}

// ReadPlmnUePolicySet - Retrieve the UE policy set data for an H-PLMN
func (s *PlmnUePolicySetDocumentAPIService) ReadPlmnUePolicySet(ctx context.Context, plmnId string) (ImplResponse, error) {
	// TODO - update ReadPlmnUePolicySet with the required logic for this service method.
	// Add api_plmn_ue_policy_set_document_service.go to the .openapi-generator-ignore to avoid overwriting this service implementation when updating open api generation.
	...
	return Response(http.StatusNotImplemented, nil), errors.New("ReadPlmnUePolicySet method not implemented")
}
