...
// PolicyDataSubscriptionsCollectionAPIService is a service that implements the logic for the PolicyDataSubscriptionsCollectionAPIServicer
// This service should implement the business logic for every endpoint for the PolicyDataSubscriptionsCollectionAPI API.
// Include any external packages or services that will be required by this service.
type PolicyDataSubscriptionsCollectionAPIService struct {
}

// NewPolicyDataSubscriptionsCollectionAPIService creates a default api service
func NewPolicyDataSubscriptionsCollectionAPIService() PolicyDataSubscriptionsCollectionAPIServicer {
	return &PolicyDataSubscriptionsCollectionAPIService{}
}

// CreateIndividualPolicyDataSubscription - Create a subscription to receive notification of policy data changes
func (s *PolicyDataSubscriptionsCollectionAPIService) CreateIndividualPolicyDataSubscription(ctx context.Context, policyDataSubscription PolicyDataSubscription) (ImplResponse, error) {
	// TODO - update CreateIndividualPolicyDataSubscription with the required logic for this service method.
	// Add api_policy_data_subscriptions_collection_service.go to the .openapi-generator-ignore to avoid overwriting this service implementation when updating open api generation.

	// TODO: Uncomment the next line to return response Response(201, PolicyDataSubscription{}) or use other options such as http.Ok ...
	// return Response(201, PolicyDataSubscription{}), nil
	...
	return Response(http.StatusNotImplemented, nil), errors.New("CreateIndividualPolicyDataSubscription method not implemented")
}
