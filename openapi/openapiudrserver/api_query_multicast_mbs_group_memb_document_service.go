...
// QueryMulticastMbsGroupMembDocumentAPIService is a service that implements the logic for the QueryMulticastMbsGroupMembDocumentAPIServicer
// This service should implement the business logic for every endpoint for the QueryMulticastMbsGroupMembDocumentAPI API.
// Include any external packages or services that will be required by this service.
type QueryMulticastMbsGroupMembDocumentAPIService struct {
}

// NewQueryMulticastMbsGroupMembDocumentAPIService creates a default api service
func NewQueryMulticastMbsGroupMembDocumentAPIService() QueryMulticastMbsGroupMembDocumentAPIServicer {
	return &QueryMulticastMbsGroupMembDocumentAPIService{}
}

// GetMulticastMbsGroupMemb - Retrieve a 5GmbsGroup
func (s *QueryMulticastMbsGroupMembDocumentAPIService) GetMulticastMbsGroupMemb(ctx context.Context, externalGroupId string) (ImplResponse, error) {
	// TODO - update GetMulticastMbsGroupMemb with the required logic for this service method.
	// Add api_query_multicast_mbs_group_memb_document_service.go to the .openapi-generator-ignore to avoid overwriting this service implementation when updating open api generation.

	// TODO: Uncomment the next line to return response Response(200, MulticastMbsGroupMemb{}) or use other options such as http.Ok ...
	// return Response(200, MulticastMbsGroupMemb{}), nil
	...
	return Response(http.StatusNotImplemented, nil), errors.New("GetMulticastMbsGroupMemb method not implemented")
}
