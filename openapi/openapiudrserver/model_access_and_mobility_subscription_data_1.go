...
// AssertAccessAndMobilitySubscriptionData1Required checks if the required fields are not zero-ed
func AssertAccessAndMobilitySubscriptionData1Required(obj AccessAndMobilitySubscriptionData1) error {
	...
	if obj.Nssai != nil {
		if err := AssertNssai1Required(*obj.Nssai); err != nil {
			return err
		}
	}
	...
	if err := AssertSorInfo1Required(obj.SorInfo); err != nil {
		return err
	}
	...
	if err := AssertUpuInfo1Required(obj.UpuInfo); err != nil {
		return err
	}
	...
	if err := AssertMdtConfiguration1Required(obj.MdtConfiguration); err != nil {
		return err
	}
	...
	if err := AssertCagData1Required(obj.CagData); err != nil {
		return err
	}
	...
	if err := AssertExpectedUeBehaviourData1Required(obj.ExpectedUeBehaviourList); err != nil {
		return err
	}
	...
	for _, el := range obj.EdrxParametersList {
		if err := AssertEdrxParameters1Required(el); err != nil {
			return err
		}
	}
	for _, el := range obj.PtwParametersList {
		if err := AssertPtwParameters1Required(el); err != nil {
			return err
		}
	}
	...
	if err := AssertWirelineServiceAreaRestriction1Required(obj.WirelineServiceAreaRestriction); err != nil {
		return err
	}
	for _, el := range obj.PcfSelectionAssistanceInfos {
		if err := AssertPcfSelectionAssistanceInfo1Required(el); err != nil {
			return err
		}
	}
	if err := AssertAerialUeSubscriptionInfo1Required(obj.AerialUeSubInfo); err != nil {
		return err
	}
...
// AssertAccessAndMobilitySubscriptionData1Constraints checks if the values respects the defined constraints
func AssertAccessAndMobilitySubscriptionData1Constraints(obj AccessAndMobilitySubscriptionData1) error {
