...
func AssertAccessTokenReqRequired(obj AccessTokenReq) error {
	...
	if err := AssertPlmnId1Required(obj.RequesterPlmn); err != nil {
		return err
	}
	...
	for _, el := range obj.RequesterSnpnList {
		if err := AssertPlmnIdNid1Required(el); err != nil {
			return err
		}
	}
	if err := AssertPlmnId1Required(obj.TargetPlmn); err != nil {
		return err
	}
	if err := AssertPlmnIdNid1Required(obj.TargetSnpn); err != nil {
		return err
	}
