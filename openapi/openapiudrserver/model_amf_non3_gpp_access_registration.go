...
// AssertAmfNon3GppAccessRegistrationRequired checks if the required fields are not zero-ed
func AssertAmfNon3GppAccessRegistrationRequired(obj AmfNon3GppAccessRegistration) error {
...
// AssertAmfNon3GppAccessRegistrationConstraints checks if the values respects the defined constraints
func AssertAmfNon3GppAccessRegistrationConstraints(obj AmfNon3GppAccessRegistration) error {
	return nil
}
