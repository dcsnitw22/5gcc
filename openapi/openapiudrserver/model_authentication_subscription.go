...
// AssertAuthenticationSubscriptionRequired checks if the required fields are not zero-ed
func AssertAuthenticationSubscriptionRequired(obj AuthenticationSubscription) error {
	...
	if err := AssertAuthMethodRequired(obj.AuthenticationMethod); err != nil {
		return err
	}
	if err := AssertSequenceNumberRequired(obj.SequenceNumber); err != nil {
		return err
	}
	if err := AssertAuthMethodRequired(obj.N5gcAuthMethod); err != nil {
		return err
	}
	return nil
}

// AssertAuthenticationSubscriptionConstraints checks if the values respects the defined constraints
func AssertAuthenticationSubscriptionConstraints(obj AuthenticationSubscription) error {
	return nil
}
