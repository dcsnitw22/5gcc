...
// AssertEeGroupProfileDataRequired checks if the required fields are not zero-ed
func AssertEeGroupProfileDataRequired(obj EeGroupProfileData) error {
	for _, el := range obj.RestrictedEventTypes {
...
// AssertEeGroupProfileDataConstraints checks if the values respects the defined constraints
func AssertEeGroupProfileDataConstraints(obj EeGroupProfileData) error {
	return nil
}
