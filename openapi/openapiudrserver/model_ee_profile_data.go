...
// AssertEeProfileDataRequired checks if the required fields are not zero-ed
func AssertEeProfileDataRequired(obj EeProfileData) error {
...
// AssertEeProfileDataConstraints checks if the values respects the defined constraints
func AssertEeProfileDataConstraints(obj EeProfileData) error {
	return nil
}
