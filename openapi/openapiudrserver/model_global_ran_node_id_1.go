...
// AssertGlobalRanNodeId1Required checks if the required fields are not zero-ed
func AssertGlobalRanNodeId1Required(obj GlobalRanNodeId1) error {
...
// AssertGlobalRanNodeId1Constraints checks if the values respects the defined constraints
func AssertGlobalRanNodeId1Constraints(obj GlobalRanNodeId1) error {
	return nil
}
