...
// AssertIptvConfigDataRequired checks if the required fields are not zero-ed
func AssertIptvConfigDataRequired(obj IptvConfigData) error {
	elements := map[string]interface{}{
		"afAppId":       obj.AfAppId,
		"multiAccCtrls": obj.MultiAccCtrls,
	}
...
// AssertIptvConfigDataConstraints checks if the values respects the defined constraints
func AssertIptvConfigDataConstraints(obj IptvConfigData) error {
	return nil
}
