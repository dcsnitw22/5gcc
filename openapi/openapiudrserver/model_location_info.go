...
func AssertLocationInfoRequired(obj LocationInfo) error {
	elements := map[string]interface{}{
		"registrationLocationInfoList": obj.RegistrationLocationInfoList,
	}
	...
	for _, el := range obj.RegistrationLocationInfoList {
		if err := AssertRegistrationLocationInfoRequired(el); err != nil {
			return err
		}
	}
	return nil
