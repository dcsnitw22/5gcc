...
// AssertMdtConfiguration1Required checks if the required fields are not zero-ed
func AssertMdtConfiguration1Required(obj MdtConfiguration1) error {
	...
	for _, el := range obj.MdtAllowedPlmnIdList {
		if err := AssertPlmnId1Required(el); err != nil {
			return err
		}
	}
	...
	for _, el := range obj.InterFreqTargetList {
		if err := AssertInterFreqTargetInfo1Required(el); err != nil {
			return err
		}
	}
	return nil
...
// AssertMdtConfiguration1Constraints checks if the values respects the defined constraints
func AssertMdtConfiguration1Constraints(obj MdtConfiguration1) error {
