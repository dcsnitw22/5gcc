...
// AssertNssai1Required checks if the required fields are not zero-ed
func AssertNssai1Required(obj Nssai1) error {
...
// AssertNssai1Constraints checks if the values respects the defined constraints
func AssertNssai1Constraints(obj Nssai1) error {
	return nil
}
