...
// AssertPp5gMbsGroupProfileDataRequired checks if the required fields are not zero-ed
func AssertPp5gMbsGroupProfileDataRequired(obj Pp5gMbsGroupProfileData) error {
	return nil
}

// AssertPp5gMbsGroupProfileDataConstraints checks if the values respects the defined constraints
func AssertPp5gMbsGroupProfileDataConstraints(obj Pp5gMbsGroupProfileData) error {
	return nil
}
