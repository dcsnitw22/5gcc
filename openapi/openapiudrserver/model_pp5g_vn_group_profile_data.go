...
// AssertPp5gVnGroupProfileDataRequired checks if the required fields are not zero-ed
func AssertPp5gVnGroupProfileDataRequired(obj Pp5gVnGroupProfileData) error {
	return nil
}

// AssertPp5gVnGroupProfileDataConstraints checks if the values respects the defined constraints
func AssertPp5gVnGroupProfileDataConstraints(obj Pp5gVnGroupProfileData) error {
	return nil
}
