...
// AssertPpProfileDataRequired checks if the required fields are not zero-ed
func AssertPpProfileDataRequired(obj PpProfileData) error {
	return nil
}

// AssertPpProfileDataConstraints checks if the values respects the defined constraints
func AssertPpProfileDataConstraints(obj PpProfileData) error {
	return nil
}
