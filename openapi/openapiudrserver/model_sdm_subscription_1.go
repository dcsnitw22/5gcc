...
// AssertSdmSubscription1Required checks if the required fields are not zero-ed
func AssertSdmSubscription1Required(obj SdmSubscription1) error {
	...
	if err := AssertUeContextInSmfDataSubFilter1Required(obj.UeConSmfDataSubFilter); err != nil {
		return err
	}
	return nil
}

// AssertSdmSubscription1Constraints checks if the values respects the defined constraints
func AssertSdmSubscription1Constraints(obj SdmSubscription1) error {
	return nil
}
