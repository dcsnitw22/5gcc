...
// AssertServiceParameterDataRequired checks if the required fields are not zero-ed
func AssertServiceParameterDataRequired(obj ServiceParameterData) error {
...
// AssertServiceParameterDataConstraints checks if the values respects the defined constraints
func AssertServiceParameterDataConstraints(obj ServiceParameterData) error {
	return nil
}
