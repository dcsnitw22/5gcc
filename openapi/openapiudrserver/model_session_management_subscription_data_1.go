...
// AssertSessionManagementSubscriptionData1Required checks if the required fields are not zero-ed
func AssertSessionManagementSubscriptionData1Required(obj SessionManagementSubscriptionData1) error {
...
// AssertSessionManagementSubscriptionData1Constraints checks if the values respects the defined constraints
func AssertSessionManagementSubscriptionData1Constraints(obj SessionManagementSubscriptionData1) error {
	return nil
}
