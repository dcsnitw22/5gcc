...
// AssertSmPolicyDataRequired checks if the required fields are not zero-ed
func AssertSmPolicyDataRequired(obj SmPolicyData) error {
	elements := map[string]interface{}{
		"smPolicySnssaiData": obj.SmPolicySnssaiData,
	}
...
// AssertSmPolicyDataConstraints checks if the values respects the defined constraints
func AssertSmPolicyDataConstraints(obj SmPolicyData) error {
	return nil
}
