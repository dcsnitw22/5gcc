...
// AssertSmPolicyDnnDataRequired checks if the required fields are not zero-ed
func AssertSmPolicyDnnDataRequired(obj SmPolicyDnnData) error {
	...
	if err := AssertChargingInformationRequired(obj.ChfInfo); err != nil {
		return err
	}
	return nil
}

// AssertSmPolicyDnnDataConstraints checks if the values respects the defined constraints
func AssertSmPolicyDnnDataConstraints(obj SmPolicyDnnData) error {
	return nil
}
