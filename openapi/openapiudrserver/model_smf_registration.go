...
// AssertSmfRegistrationRequired checks if the required fields are not zero-ed
func AssertSmfRegistrationRequired(obj SmfRegistration) error {
	...
	// 	}
	// }
	if err := AssertRegistrationReasonRequired(obj.RegistrationReason); err != nil {
		return err
	}
...
// AssertSmfRegistrationConstraints checks if the values respects the defined constraints
func AssertSmfRegistrationConstraints(obj SmfRegistration) error {
