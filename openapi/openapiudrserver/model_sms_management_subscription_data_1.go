...
// AssertSmsManagementSubscriptionData1Required checks if the required fields are not zero-ed
func AssertSmsManagementSubscriptionData1Required(obj SmsManagementSubscriptionData1) error {
...
// AssertSmsManagementSubscriptionData1Constraints checks if the values respects the defined constraints
func AssertSmsManagementSubscriptionData1Constraints(obj SmsManagementSubscriptionData1) error {
	return nil
}
