...
// AssertTrafficInfluDataRequired checks if the required fields are not zero-ed
func AssertTrafficInfluDataRequired(obj TrafficInfluData) error {
...
// AssertTrafficInfluDataConstraints checks if the values respects the defined constraints
func AssertTrafficInfluDataConstraints(obj TrafficInfluData) error {
