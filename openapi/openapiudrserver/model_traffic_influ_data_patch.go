...
// AssertTrafficInfluDataPatchRequired checks if the required fields are not zero-ed
func AssertTrafficInfluDataPatchRequired(obj TrafficInfluDataPatch) error {
...
// AssertTrafficInfluDataPatchConstraints checks if the values respects the defined constraints
func AssertTrafficInfluDataPatchConstraints(obj TrafficInfluDataPatch) error {
