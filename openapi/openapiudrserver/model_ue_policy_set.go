...
// AssertUePolicySetRequired checks if the required fields are not zero-ed
func AssertUePolicySetRequired(obj UePolicySet) error {
	return nil
}

// AssertUePolicySetConstraints checks if the values respects the defined constraints
func AssertUePolicySetConstraints(obj UePolicySet) error {
	return nil
}
