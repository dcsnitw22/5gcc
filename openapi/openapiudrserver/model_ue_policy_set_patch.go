...
// AssertUePolicySetPatchRequired checks if the required fields are not zero-ed
func AssertUePolicySetPatchRequired(obj UePolicySetPatch) error {
	return nil
}

// AssertUePolicySetPatchConstraints checks if the values respects the defined constraints
func AssertUePolicySetPatchConstraints(obj UePolicySetPatch) error {
	return nil
}
