...
// AssertUmtTime1Required checks if the required fields are not zero-ed
func AssertUmtTime1Required(obj UmtTime1) error {
...
// AssertUmtTime1Constraints checks if the values respects the defined constraints
func AssertUmtTime1Constraints(obj UmtTime1) error {
	if obj.DayOfWeek < 1 {
