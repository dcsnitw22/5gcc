...
// AssertUpuData2Required checks if the required fields are not zero-ed
func AssertUpuData2Required(obj UpuData2) error {
...
// AssertUpuData2Constraints checks if the values respects the defined constraints
func AssertUpuData2Constraints(obj UpuData2) error {
	return nil
}
