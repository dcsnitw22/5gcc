...
// AssertUpuInfo1Required checks if the required fields are not zero-ed
func AssertUpuInfo1Required(obj UpuInfo1) error {
	...
	for _, el := range obj.UpuDataList {
		if err := AssertUpuData2Required(el); err != nil {
			return err
		}
	}
	return nil
...
// AssertUpuInfo1Constraints checks if the values respects the defined constraints
func AssertUpuInfo1Constraints(obj UpuInfo1) error {
	return nil
}
