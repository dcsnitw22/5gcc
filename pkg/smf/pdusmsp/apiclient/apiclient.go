...
// called by sm
func (a *ApiClientInfo) N1N2MessageTransfer(sourceIP string, n1N2MessageTransferReqData openapi_commn_client.N1N2MessageTransferReqData, binaryDataN1MessageContentFile *os.File, binaryDataN2InfoContentFile *os.File) {

	ueContextId := "dummyUeContextId"
