...
type SessionMessageInfo struct {
	...
	UdmsdmsMsg     api.SessionMessage // Message
}

type UdmsdmspSessionWorkers struct {
...
func (p *UdmsdmspSessionWorkers) HandleSessionMessages(msgInfo *SessionMessageInfo) {
...
func (p *UdmsdmspSessionWorkers) sessionWorkerHandler(sessionMessages <-chan SessionMessageInfo) {
...
func (p *UdmsdmspSessionWorkers) RemoveSessionWorkers(deletedSessions map[SessionId]struct{}) error {
	p.sessionLock.Lock()
	defer p.sessionLock.Unlock()
