...
type Grpc interface {
	...
	SendN1N2MessageData(int32, *protos.N1N2MessageTransferDataRequest)
}
	...
	go func() {
		for {
			...
			case ch := <-g.WatchGrpcChannel():
				...
				g.SendN1N2MessageData(pduSessionId, &n1n2Data)
			}
		}
	}()
}
...
func (g *GrpcInfo) SendN1N2MessageData(pduSessionId int32, n1n2Data *protos.N1N2MessageTransferDataRequest) {
	g.grpcClient.SendN1N2MessageData(pduSessionId, n1n2Data)
}
